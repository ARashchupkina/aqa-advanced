...
class Ebook extends Book {
    ...
    constructor (name, author, year, fileFormat) {  // Викликаємо конструктор батьківського класу 
    ...
    set fileFormat(fileFormat) {
        ...
        if (allowedFormats.includes(fileFormat)) {
            ...
            console.error(`Invalid format. Allowed formats are: ${allowedFormats.join(", ")}`);
        }
    };
    ...
    printInfo() {
        console.log(`Name: ${this.name}, Author: ${this.author}, Year: ${this.year}, Format: ${this.fileFormat}`);
    }
